...
/* 
This file is not used by HBook. It is just here for reference because some lines of this library have been changed.
Search for "hotelwp".
The file which is actually used is jquery.datepick.min.js
In jquery.datepick.min.js the commented out lines are deleted.
*/
 ...
 $.datepick.newDate(2014, 12, 25) */
		...
		_doMouseWheel: function(event, delta) {
			...
			if (inst.options.useMouseWheel) {
				...
				event.preventDefault(); // added by hotelwp
			}
			// removed by hotelwp
			// event.preventDefault();
		},
