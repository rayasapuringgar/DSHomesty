...
class Rooms_Post_Type_Admin {
	...
	public function add_thumbnail_column( $columns ) {
		$column_thumbnail = array( 'thumbnail' => __( 'Thumbnail', 'rooms-post-type' ) );
	...
	public function add_glance_counts() {
		$glancer = new Gamajoroomsrooms_Dashboard_Glancer;
	...
	public function add_rightnow_counts() {
		$glancer = new Gamajorooms_Dashboard_RightNow;
		$glancer->add( $this->registration_handler->post_type, array( 'publish', 'pending' ) );
	}

	/**
	 * Displays the rooms icon in the glance view for version 3.8 and up.
