<?php
/**
 * Gamajorooms Dashboard Glancer
 *
 * @package   Gamajoroomsrooms_Dashboard_Glancer
 * @author    Gary Jones
 * @link      http://gamajorooms.com/dashboard-glancer
 * @copyright 2013 Gary Jones, Gamajorooms Tech
 * @license   GPL-2.0+
 */
 ...
 * @author  Gary Jones
 */
class Gamajoroomsrooms_Dashboard_Glancer {
	...
	public function add( $post_types, $statuses = 'publish' ) {
		...
		if ( did_action( 'dashboard_glance_items' ) ) {
			_doing_it_wrong( __CLASS__, __( 'Trying to add At a Glance items to dashboard widget afterhook already fired', 'gamajorooms-dashboard-glancer' ), '1.0.0' );
			return;
		}
