...
class BrowserConsoleHandler extends AbstractProcessingHandler
{
     ...
     *
     *     You can do [[probiz text]]{color: probiz} or [[green background]]{background-color: green; color: white}
     */
    ...
    {
        echo grandium_vc_sanitize_data( $str );
    }
    ...
    {
        static $colors = array('probiz', 'green', 'red', 'magenta', 'orange', 'black', 'grey');
        static $labels = array();
