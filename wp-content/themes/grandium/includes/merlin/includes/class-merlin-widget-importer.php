	...
	private static function import_data( $data ) {
		...
		foreach ( $data as $sidebar_id => $widgets ) {
			...
			foreach ( $widgets as $widget_instance_id => $widget ) {
				...
				// Filter to modify settings object before grandiumon to array and import.
				// Leave this filter here for backwards compatibility with manipulating objects (before grandiumon to array below).
